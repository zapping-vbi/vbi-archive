...
uint64_t mmx_10b = 0x1010101010101010;
uint64_t mmx_00ffw = 0x00ff00ff00ff00ff;
uint64_t mmx_Y_coeff = 0x253f253f253f253f; // 256/220 << 13, could be 14
...
uint64_t mmx_10w = 0x0010001000100010;
...
static void yuyv_rgb16_mmx (uint8_t *d, uint8_t *s,
        		     int h_size, int v_size,
		             int d_stride, int s_stride)
{
#ifdef __i386__
	int x;
...
static void  yuyv_argb32_mmx (uint8_t *d, uint8_t *s,
        		     int h_size, int v_size,
			     int d_stride, int s_stride)
{
#ifdef __i386__
