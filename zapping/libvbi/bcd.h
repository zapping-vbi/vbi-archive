...
/* $Id: bcd.h,v 1.2 2005-01-08 14:54:20 mschimek Exp $ */
...
extern int
vbi3_dec2bcd			(int			dec) vbi3_const;
extern int
vbi3_bcd2dec			(int			bcd) vbi3_const;
...
vbi3_is_bcd			(int			bcd)
{
	...
	return 0 == (((bcd + _VBI3_BCD_06) ^ bcd ^ _VBI3_BCD_06) & _VBI3_BCD_10);
}
