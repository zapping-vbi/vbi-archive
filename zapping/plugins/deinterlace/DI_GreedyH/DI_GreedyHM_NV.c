/////////////////////////////////////////////////////////////////////////////
// $Id: DI_GreedyHM_NV.c,v 1.1 2005-01-08 14:54:23 mschimek Exp $
/////////////////////////////////////////////////////////////////////////////
...
// Revision 1.5  2001/11/13 17:24:49  trbarry
...
_restore(eax)
_asm_end,
_m(WeaveDest), _m(pL2), _m(L1), _m(L3), _m(OverlayPitch),
_m_nth(LastAvg, 6), _m(pFieldStore), _m(pFieldStoreEnd), _m(CopyDest),
_m(LastAvg), _m(MaxCombW), _m(MotionThresholdW), _m(MotionSenseW),
_m(QW256), _m(YMaskW), _m(UVMask), _m(SaveQword1), _m(SaveQword2),
_m(SaveQword3), _m(LoopCtr), _m(DestIncr));
