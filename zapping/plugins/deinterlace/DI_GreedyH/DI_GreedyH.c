...
//Z #include "resource.h"
//Z #include "commctrl.h"
//Z #include "..\..\DScaler\Slider.h"
...
SETTING DI_GreedyHSettings[DI_GREEDYH_SETTING_LASTONE] =
{
	...
	{
		N_("Motion Threshold"), SLIDER, 0,	// szDisplayName, TYPE, orig val
	...
	{
		N_("Motion Sense"), SLIDER, 0,	// szDisplayName, TYPE, orig val
	...
	{
		N_("Good PullDown Lvl"), SLIDER, 0,		// szDisplayName, TYPE, orig val
	...
	{
		N_("Bad PullDown Lvl"), SLIDER, 0,	// szDisplayName, TYPE, orig val
	...
	{
		N_("H. Sharpness"), SLIDER, 0,		// szDisplayName, TYPE, orig val
	...
	{
		N_("V. Sharpness"), SLIDER, 0,		// szDisplayName, TYPE, orig val
    ...
    {
		N_("Median Filter"), SLIDER, 0,		// szDisplayName, TYPE, orig val
	...
	{
		N_("High Comb Skip"), SLIDER, 0,	// szDisplayName, TYPE, orig val
	...
	{
		N_("Auto Pull-Down"), ONOFF, 0,		// szDisplayName, TYPE, orig val
	...
	{
		N_("In-Between Frames"), ONOFF, 0,	// szDisplayName, TYPE, orig val
	...
	{
		N_("Median Filter"), ONOFF, 0,		// szDisplayName, TYPE, orig val
	...
	{
		N_("V. Sharpness"), ONOFF, 0,	// szDisplayName, TYPE, orig val
	...
	{
		N_("H. Sharpness"), ONOFF, 0,		// szDisplayName, TYPE, orig val
