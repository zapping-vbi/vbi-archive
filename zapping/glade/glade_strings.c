...
gchar *s = N_("Up");
gchar *s = N_("Select the next station in the chanel list [Page Down]");
gchar *s = N_("Down");
...
gchar *s = N_("Channel");
gchar *s = N_("Freq (kHz)");
gchar *s = N_("Add all the channels in the current country to the channel list.");
...
gchar *s = N_("Select here the Standard this channel uses");
