...
gchar *s = N_("Select the previous station in the channel list [Page Up]");
gchar *s = N_("Up");
gchar *s = N_("Select the next station in the channel list [Page Down]");
gchar *s = N_("Down");
...
gchar *s = N_("Swap the behaviour of the PageUp and Page Down keys");
gchar *s = N_("Swap Channel Up/Down keys");
gchar *s = N_("Hide mouse pointer");
...
gchar *s = N_("program_info");
gchar *s = N_("[title (large)]");
gchar *s = N_("[date, length, elapsed]");
gchar *s = N_("[audio]");
gchar *s = N_("[caption]");
gchar *s = N_("[rating]");
gchar *s = N_("[type]");
gchar *s = N_("Synopsis");
gchar *s = N_("[Long time ago...]");
