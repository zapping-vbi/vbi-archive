...
gchar *s = N_("This option is for returning to windowed mode from fullscreen");
gchar *s = N_("Go _Windowed");
gchar *s = N_("Options for when going Zapping");
...
gchar *s = N_("Symbol");
gchar *s = N_("Hash");
gchar *s = N_("label74 (prototype)");
gchar *s = N_("label75 (symbol description)");
gchar *s = N_("Click here when you are done with the plugins");
gchar *s = N_("Activate (start) the plugin");
gchar *s = N_("Start Plugin");
gchar *s = N_("Stop the plugin");
gchar *s = N_("Stop Plugin");
gchar *s = N_("dialog1");
...
gchar *s = N_("kHz");
gchar *s = N_("label43");
gchar *s = N_("This tries to find the best signal around this frequence");
gchar *s = N_("A_utoTune");
