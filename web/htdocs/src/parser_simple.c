...
½THE_REST
<p>I would want to thank <a href="http://sourceforge.net"><img
...
ALT="ResCD"></a> <form action="<?php echo $PHP_SELF ?>" method="POST">
...
</select><input type="submit" border="0" name="Submit" value="Change">
</form>
</center>
</body>
</html>
