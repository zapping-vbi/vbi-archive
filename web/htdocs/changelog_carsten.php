...
<head>
<title>
Zapping -- Linux TV Viewer -- ChangeLog
</title>
<!--
	Generated from changelog.xml on Wed Mar 13 08:23:38 2002
-->
...
<td width="127" height="107"><a href="index.php"><img src="images_carsten/zapping-tv/channel08.jpg" width="127" height="107" border="0" alt="Zapping a TV Viewer for Linux"></a></td>
...
<img src="images_carsten/zapping-tv/ch08.jpg" width="46" height="35" border="0" align=left hspace="0" vspace="0" alt="">
...
<td width="218" height="44"><img src="images_carsten/logo/logo-changelog.png" width="218" height="44" border="0" alt="Changes in Zapping"></td>
...
<td width="100%" height="100%" bgcolor="#000099" valign="top"><center><h2>Latest CVS entries</h2></center><?php $file_location = "http://cvs.sourceforge.net/cgi-bin/viewcvs.cgi/~checkout~/zapping/zapping/ChangeLog?content-type=text/plain";
...
if ($file) {
  ...
  print("</pre>");
  print("<b>");
  print("The complete ChangeLog is available
	<a href=\"$file_location\">here</a>.");
  print("</b>");
} else {
  print("<b>Error:</b> Couldn't open the ChangeLog for reading,
	it is available from <a href=\"$file_location\">here</a>.");
}
?></td>
