...
<link REL="icon" HREF="/bookmark.ico" TYPE="image/png">
  ...
  <body link="yellow" vlink="yellow" text="yellow" bgcolor="#464646">
    <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td align="left"><h1>Downloading</h1></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="contents" width="100%" valign="top"><h2>Requirements for running Zapping</h2><ul><li>V4L, V4L2 or XVideo support for your TV card</li><li>A working Gnome desktop, with the common libraries</li><li>The <b>zvbi library</b>, available from the <a href="http://sourceforge.net/project/showfiles.php?group_id=2599">Zapping
      ...
      and Zapping, respectively.</li></ul><h2>RPM packages</h2>
...
./prepare_dist.sh
    ...
    both maintained by Christian Marillat.</p><h2>Compiling Zapping</h2><p>If you want to compile Zapping yourself, make sure you have
    ...
    further details.</p><h2>Downloading via HTTP</h2><p>You can download the latest version of Zapping from the <a href="http://sourceforge.net/projects/zapping">SourceForge
    ...
    the same place.</p><a name="CVS"></a><h2>Downloading via CVS</h2><p>To get the latest development version of Zapping you can
