...
<html>
  <!--
  Generated from links_modern.xml on Thu Mar 13 18:53:46 2003
  -->
  <head>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td align="left"><h1>Other&nbsp;software</h1></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="contents" width="100%" valign="top"><h2>TV programs for Linux</h2>
