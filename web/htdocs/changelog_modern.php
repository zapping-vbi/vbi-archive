        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td align="left"><h1>CVS&nbsp;ChangeLog</h1></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="contents" width="100%" valign="top"><h2>Latest CVS entries</h2><?php $file_location = "http://cvs.sourceforge.net/cgi-bin/viewcvs.cgi/~checkout~/zapping/zapping/ChangeLog?content-type=text/plain";
