...
<html>
  <!--
  Generated from contact_modern.xml on Sun Feb 16 18:18:45 2003
  -->
  <head>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td align="left"><h1>Contacting&nbsp;us</h1></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="contents" width="100%" valign="top"><h2>The mailing list</h2>
...
mailing list page</a>.
<a name="bugs"></a>
<h2>What to do if you find a bug</h2><p>If you have any problems, please leave a bug report in the
