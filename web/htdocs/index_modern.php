...
<html>
  <!--
  Generated from index_modern.xml on Sun Feb 16 18:18:45 2003
  -->
  <head>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td align="left"><h1>Zapping&nbsp;Info</h1></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td width="100%">
          <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="contents" width="100%" valign="top"><h2>New release</h2><ul><li><b>Zapping</b> 0.6.6
