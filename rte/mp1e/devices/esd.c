...
/* $Id: esd.c,v 1.6 2002-12-14 00:43:44 mschimek Exp $ */
...
void
open_pcm_esd(char *unused, int sampling_rate, rte_bool stereo, fifo **f)
{
...
void
open_pcm_esd(char *dev_name, int sampling_rate, rte_bool stereo, fifo **f)
{
